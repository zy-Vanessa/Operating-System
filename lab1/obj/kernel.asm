...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020045c:	87050513          	addi	a0,a0,-1936 # 80200cc8 <etext+0x25e>
...
void exception_handler(struct trapframe *tf) {
    ...
    802004f4:	71850513          	addi	a0,a0,1816 # 80200c08 <etext+0x19e>
    802004f8:	b75ff0ef          	jal	ra,8020006c <cprintf>
            cprintf("ebreak caught at 0x%08x\n", tf->epc);
    802004fc:	10843583          	ld	a1,264(s0)
    80200500:	00000517          	auipc	a0,0x0
    80200504:	72850513          	addi	a0,a0,1832 # 80200c28 <etext+0x1be>
